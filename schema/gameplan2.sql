...
-- Tue 02 May 2017 12:25:17 AM PKT
...
-- -----------------------------------------------------
-- Table `portfoliReleases`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `portfoliReleases` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `portfoliReleases` (
  `portfolioid` INT NOT NULL,
